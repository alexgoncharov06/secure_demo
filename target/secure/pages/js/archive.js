...
function createTableSettings(BaseId){
    ...
    // divForTable.className = 'col-xs-12 col-md-8 ';
	var nameBaseId = document.createElement("h1");
    nameBaseId.className = "text-center";
   ...
   typeSensor.appendChild(nameBaseId);
    ...
    tableSensor.className = 'table table-striped table-condensed ';
...
//                    rowsSensor.setAttribute('style', 'background-color : ' + color + '; opacity : 0,7');
        ...
        if (countSensors == 0) {
            ...
            tableSensor.tBodies.namedItem(sensid).innerHTML = '';
