...
var buttonBack =  document.getElementById('buttonBack');
    ...
    name1.textContent = 'Название точки: ';
    name1.id = 'name1';
...
//            Address of point
    ...
    address1.textContent = 'Адрес точки: ';
    ...
    location1 .textContent = 'Геопозиция точки:';
    location1.id = 'loc1';
...
//            cell1.appendChild(typeSensor);
    ...
    var cellSensor6 =  rowsSensor.insertCell(-1);
    cellSensor6.innerHTML = 'Критическая <br>ошибка';
    cellSensor6.setAttribute('style','text-align:center;');
...
//          Создание таблицы для температурных датчиков
    ...
    for (var i = 0; i < 24; i++) {
        ...
        var criticalError = document.createElement('input');
        criticalError.type = 'checkbox';
        criticalError.name = 'criticalError_' + num;
        criticalError.id = 'criticalError_' + num;
        ...
        var cellSensor6 =  rowsSensor.insertCell(-1);
        cellSensor6.appendChild(criticalError);
        cellSensor6.setAttribute('style','text-align:center;');
...
//            Добавление таблицы для Дискретных датчиков
    ...
    var cellSensorDT5 =  rowsSensor1.insertCell(-1);
    cellSensorDT5.innerHTML = 'Критическая <br>ошибка';
    cellSensorDT5.setAttribute('style','text-align:center;');
...
//            Создание таблицы для дискретных датчиков
    for (var i = 0; i < 16; i++) {
        ...
        var criticalError = document.createElement('input');
        criticalError.type = 'checkbox';
        criticalError.name = 'criticalError_dt_' + num;
        criticalError.id = 'criticalError_dt_' + num;
        ...
        var cellSensorDT5 =  rowsSensor1.insertCell(-1);
        cellSensorDT5.appendChild(criticalError);
        cellSensorDT5.setAttribute('style','text-align:center;');
    ...
    if (sensor_baseId.sensors !== undefined) {
        for (var i = 0 ; i < sensor_baseId.sensors.length; i++){
            if (sensor_baseId.sensors[i].type === 'tm') {
                ...
                var criticalError = document.getElementById('criticalError_'+num);
                criticalError.checked = sensor_baseId.sensors[i].criticalError
                ...
                var criticalError = document.getElementById('criticalError_dt_'+num);
                criticalError.checked = sensor_baseId.sensors[i].criticalError
...
//
        ...
        if (used || document.getElementById('sensor_name_' + num).value) {
            ...
            sens.used = used;
            sens.criticalError = formSens.elements.namedItem('criticalError_' + num).checked;
...
//                    sens.used = document.getElementById('sensor_on_' + num).checked;
    ...
    for (var i = 0; i < 16; i++) {
        ...
        if (used || document.getElementById('sensor_dt_name_' + num).value) {
            ...
            sens.used = used;
            sens.criticalError = formSens.elements.namedItem('criticalError_dt_' + num).checked;
//                    sens.used = document.getElementById('sensor_on_' + num).checked;
